...
genes = {
    ...
    "BRCA1": "lihc_brca1_methylation_expression.tsv",
    "BRCA2": "lihc_brca2_methylation_expression.tsv",
    "MLH1": "lihc_mlh1_methylation_expression.tsv",
}
...
print("LIVER CANCER (LIHC) - gene breakdown\n")
