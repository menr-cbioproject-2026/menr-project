...
genes = {
    ...
    "BRCA1": "luad_brca1_methylation_expression.tsv",
    "BRCA2": "luad_brca2_methylation_expression.tsv",
    "MLH1": "luad_mlh1_methylation_expression.tsv",
}
...
print("LUNG CANCER (LUAD) - gene breakdown\n")
